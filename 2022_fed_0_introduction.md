...
- adding variables which can be accessed globally
- causes naming clashes
  - 2 scripts define a `render` function
...
![inline](./assets/es6-modules-compatibility-2022.png)
